...
#    When I send performance overview call with range "7days" and metricId "3"
#    When I send performance overview call with range "30days" and metricId "3"
#    When I send performance overview call with range "12months" and metricId "3"

#  @requiresLogin
#  Scenario: Get my profile
#    When i send get request to get the my profile

#  Scenario: create assessment without roomevent template
